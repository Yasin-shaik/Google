...
`);
      const openAPI = await axios.post("/api/openAI/generate", { prompt });
      console.log(openAPI);
  ...
  return (
    <div
      className="bg-cover d-flex flex-column align-items-end text-end justify-content-center mt-10"
      style={{
    ...
    >
      ...
      {/* Welcome Section */}
      <section className="text-white mb-2 text-end">
        <h1 className="display-4 fw-bold">
          Welcome! Let's make healthier <br />
          snack choices!
        </h1>
        <p className="lead">
      ...
      <section className="scan-box text-white text-end ms-auto p-4 d-flex flex-column align-items-end">
        ...
        <div className="scan-button-container mt-3 text-end">
          <button
          ...
          <input
            ...
            readOnly
          />
          <button className="btn btn-warning btn-lg mt-2" onClick={handleScan}>
            Analyze Product
          </button>
        </div>
      </section>
