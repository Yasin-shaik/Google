...
const jsonData = {
  ...
  Ingredient_Classification: {
    Oats: {
      ...
      Explanation: "Good source of fiber.",
    },
    "Wheat Flour": {
      Classification: "🟡 Neutral",
      Explanation: "Provides carbohydrates for energy.",
    },
    Cinnamon: {
      Classification: "🟢 Beneficial",
      Explanation: "Rich in antioxidants, may help regulate blood sugar.",
    },
  },
  Sustainability_Score: 65,
  Personalized_Recommendations: [
    {
      Recommendation: "Oatmeal with berries",
      Reason: "Provides fiber and antioxidants.",
    },
    {
      Recommendation: "Whole wheat crackers with avocado",
      Reason: "Adds healthy fats and fiber.",
    },
  ],
...
const Results = (props) => {
  const product = props.product ? props.product : jsonData;
  return (
    <Box
      sx={{
    ...
    >
      <Container maxWidth="md" className="results-container">
        ...
        <Typography variant="h5" className="score">
          ✅ AI Health Score: {product.AI_Health_Score}
        </Typography>
        ...
        <List className="ingredient-list">
          {Object.entries(product.Ingredient_Classification).map(
            ([key, value]) => (
